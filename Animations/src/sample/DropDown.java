...
public class DropDown extends Application {
    ...
    private void configureBox(VBox root) {
        ...
        container.setStyle("-fx-border-width:1px;-fx-border-style:solid;-fx-border-color:#ffffff;");
...
//        };
        ...
        final KeyFrame kfDwn = new KeyFrame(Duration.millis(2000), kvDwn1, kvDwn2, kvDwn3);
